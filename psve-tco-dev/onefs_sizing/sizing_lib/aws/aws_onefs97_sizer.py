...
class OneFS97AWSSizer(AWSSizer):

    def __init__(self):
        onefs_supported_config_path = 'onefs_sizing/raw_data/aws/aws_supported_config_onefs9.7.json'
        supported_config = AwsSupportedConfig(onefs_supported_config_path)

        onefs_perf_data_path = 'onefs_sizing/raw_data/aws/aws_perf_source_onefs9.7.json'
